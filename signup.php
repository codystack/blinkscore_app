...
<head>
    ...
    <title>BlinksCore&trade; :: Create Account</title>
    ...
    <div class="page-ath-wrap">
        <div class="page-ath-content">
            ...
            <div class="page-ath-form">
                <h2 class="page-ath-heading mb-0 pb-0">Create account</h2>
                <p class="mb-4">sign up on BlinksCore</p>
                <form id="signupForm">
                    <div class="input-item">
                        <input type="text" name="first_name" placeholder="First Name" required class="input-bordered">
                    </div>
                    <div class="input-item">
                        <input type="text" name="last_name" placeholder="Last Name" required class="input-bordered">
                    </div>
                    <div class="input-item">
                        <input type="email" name="email" placeholder="Email" required class="input-bordered">
                    </div>
                    <div class="input-item">
                        <input type="tel" name="phone" placeholder="Phone" required class="input-bordered">
                    </div>
                    <div class="input-item">
                        <input type="password" name="password" placeholder="Password" required class="input-bordered">
                    </div>
                    <div class="input-item text-left">
                        <input class="input-checkbox input-checkbox-md" id="term-condition" required type="checkbox">
                        <label for="term-condition">I agree to BlinksCore’s <a href="https://blinkscoreng.ng/privacy" target="_blank" class="text-danger">Privacy Policy</a> &amp; <a href="https://blinkscoreng.ng/terms" target="_blank" class="text-danger"> Terms.</a></label></div>
                    <button type="submit" class="btn btn-primary btn-block">Create Account</button>
                </form>
                <div class="gaps-2x"></div>
                <div class="form-note text-center">Already have an account? <a href="./" class="text-secondary"> <strong>Sign in</strong></a></div>
            </div>
